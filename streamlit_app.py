...
if selected == "Prediction":
    ...
    matchday = st.sidebar.number_input("Select matchday:", min_value=2, max_value=34, value=21, step=1, disabled=False)
...
if selected == "Evaluation":
    ...
    now = st.sidebar.number_input("Select actual matchday:", min_value=2, max_value=34, step=1, value=21, disabled=False)
    league = st.sidebar.selectbox("Select league:", ['ekstraklasa', '1liga'], disabled=False)
    sim =  10**n
