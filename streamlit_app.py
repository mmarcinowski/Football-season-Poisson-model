...
if selected == "Prediction":
    ...
    match_day = st.sidebar.number_input("Select matchday:", min_value=2, max_value=34, value=33, step=1, disabled=False)
...
if selected == "Evaluation":
    ...
    simulations = st.sidebar.slider('Select number of simulations (10^n):', value=3, min_value=1, max_value=10, step=1, disabled=False)
    actual = st.sidebar.number_input("Select actual matchday:", min_value=2, max_value=34, step=1, value=33, disabled=False)
